...
#print(erdos_renyi)
geo_model=sp.SpatialNetwork(grid=erdos_renyi.grid, adjacency=erdos_renyi.adjacency, tolerance=0.2)
link_list1, dic1=geo_model.GeoModel1_slow(n_steps=int(5e3), grid_type='euclidean', verbose=False)

erdos_renyi=sp.SpatialNetwork.ErdosRenyi(grid=grid, n_nodes=int(rect_grid_num**2),link_probability=0.1 )
geo_model=sp.SpatialNetwork(grid=erdos_renyi.grid, adjacency=erdos_renyi.adjacency, tolerance=0.1)
link_list2, dic2=geo_model.GeoModel1_slow(n_steps=int(5e3), grid_type='euclidean', verbose=False)

erdos_renyi=sp.SpatialNetwork.ErdosRenyi(grid=grid, n_nodes=int(rect_grid_num**2),link_probability=0.1 )
geo_model=sp.SpatialNetwork(grid=erdos_renyi.grid, adjacency=erdos_renyi.adjacency, tolerance=0.01)
link_list3, dic3=geo_model.GeoModel1_slow(n_steps=int(5e3), grid_type='euclidean', verbose=False)
